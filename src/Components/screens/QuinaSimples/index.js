...
export default function QuinaSimples(){
    const [myNumbers, setMyNumbers] = useState();
    const [quantityNumbers, setQuantityNumbers] = useState(5);
    ...
    function getLotteryNumbers(){
       ...
       while(lotteryNumbers.length < range){
          let newNumber = getRandomNumber(1,80);
    ...
    return(
        <View style={css.container}>
            ...
            <TextInput style={css.input} 
                        ...
                        placeholder="Quantidade de números: 5" 
